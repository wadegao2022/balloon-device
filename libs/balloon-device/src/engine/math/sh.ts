...
function sh_rotzyz_2(zc1m: number[], zs1m: number[], ycm: number[], ysm: number[], zc2m: number[], zs2m: number[], y: Float32Array, yr: Float32Array)
{
...
function sh_rotzyz_3(zc1m: number[], zs1m: number[], ycm: number[], ysm: number[], zc2m: number[], zs2m: number[], y: Float32Array, yr: Float32Array)
{
...
function sh_rotzyz_4(zc1m: number[], zs1m: number[], ycm: number[], ysm: number[], zc2m: number[], zs2m: number[], y: Float32Array, yr: Float32Array)
{
...
function sh_rotzyz_5(zc1m: number[], zs1m: number[], ycm: number[], ysm: number[], zc2m: number[], zs2m: number[], y: Float32Array, yr: Float32Array)
{
...
function sh3_rot(m: number[], zc1: number, zs1: number, yc: number, ys: number, zc2: number, zs2: number, y: Float32Array, yr: Float32Array)
{
  const zc1m = [0, 0, 0];
  const zs1m = [0, 0, 0];
...
function sh4_rot(m: number[], zc1: number, zs1: number, yc: number, ys: number, zc2: number, zs2: number, y: Float32Array, yr: Float32Array)
{
  const zc1m = [0, 0, 0, 0];
  const zs1m = [0, 0, 0, 0];
...
function sh5_rot(m: number[], zc1: number, zs1: number, yc: number, ys: number, zc2: number, zs2: number, y: Float32Array, yr: Float32Array)
{
...
//-------------------------------------------------------------------------------------
function XMSHRotate(result: Float32Array, order: number, rotMatrix: Matrix4x4, input: Float32Array): Float32Array {
  if (!result || !input)
    return null;
...
//-------------------------------------------------------------------------------------
function XMSHAdd(result: Float32Array, order: number, inputA: Float32Array, inputB: Float32Array): Float32Array {
...
// (f*(g*h) != (f*g)*h.
//-------------------------------------------------------------------------------------
function XMSHMultiply(result: Float32Array, order: number, inputF: Float32Array, inputG: Float32Array): Float32Array {
  switch (order)
  {
  case 2:
...
//-------------------------------------------------------------------------------------
export function XMSHEvalDirectionalLight(order: number, dir: Vector3, color: Vector3, resultR: Float32Array, resultG: Float32Array, resultB: Float32Array): boolean {
  if (!resultR)
    return false;
...
//-------------------------------------------------------------------------------------
export function XMSHEvalSphericalLight(order: number, pos: Vector3, radius: number, color: Vector4, resultR: Float32Array, resultG: Float32Array, resultB: Float32Array): boolean {
  if (!resultR)
    return false;
...
//-------------------------------------------------------------------------------------
export function XMSHEvalConeLight(order: number, dir: Vector3, radius: number, color: Vector3, resultR: Float32Array, resultG: Float32Array, resultB: Float32Array): boolean {
  if (!resultR)
    return false;
...
//-------------------------------------------------------------------------------------
export function XMSHEvalHemisphereLight(order: number, dir: Vector3, topColor: Vector3, bottomColor: Vector3, resultR: Float32Array, resultG: Float32Array, resultB: Float32Array): boolean {
  if (!resultR)
    return false;
